    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			img = element("img");
    			attr_dev(img, "bp", "offset-5@md \n    4@md 12@sm");
    			if (!src_url_equal(img.src, img_src_value = "handwashing.jpg")) attr_dev(img, "src", img_src_value);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 20, 12, 421);
    			attr_dev(div0, "class", "progress-bar svelte-1c1emfs");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			add_location(div0, file$2, 19, 8, 355);
    			attr_dev(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr_dev(div1, "class", "progress-container svelte-1c1emfs");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = text("Start");
    			attr_dev(h2, "bp", "offset-5@md\n    4@md\n    12@sm");
    			attr_dev(h2, "class", "svelte-1lh0lts");
    			add_location(h2, file$1, 36, 4, 1050);
    			attr_dev(div0, "bp", "grid");
    			add_location(div0, file$1, 35, 0, 1030);
    			button.disabled = /*isRunning*/ ctx[1];
    			attr_dev(button, "bp", "offset-5@md 4@md 12@sm");
    			attr_dev(button, "class", "start svelte-1lh0lts");
    			add_location(button, file$1, 46, 4, 1187);
    			attr_dev(div1, "bp", "grid");
    			add_location(div1, file$1, 45, 0, 1167);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		const timer = setInterval(
    			() => {
    				...
    				if (secondsLeft === 0) {
    					...
    					dispatch('end', { message: 'Timer ended' }); // dont need to send a object/message i.e. dispatch('end')
    				}
    			},
    			1000
    		);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-judwa1");
    			add_location(h1, file, 18, 0, 229);
    			attr_dev(a0, "href", "https://www.who.int/gpsc/clean_hands_protection/en/");
    			add_location(a0, file, 25, 4, 307);
    			attr_dev(a1, "href", "https://freesound.org/people/metrostock99/sounds/345086/");
    			add_location(a1, file, 26, 4, 392);
    			attr_dev(h3, "class", "svelte-judwa1");
    			add_location(h3, file, 24, 0, 298);
    			if (!src_url_equal(source.src, source_src_value = "sound.wav")) attr_dev(source, "src", source_src_value);
    			add_location(source, file, 30, 1, 510);
    			add_location(audio_1, file, 29, 0, 483);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
