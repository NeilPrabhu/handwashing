var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			div.innerHTML = `<img bp="offset-5@md 
    4@md 12@sm" src="handwashing.jpg" alt="How to wash your hands" class="svelte-wwxt9"/>`;
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-1c1emfs");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-1c1emfs");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			t4 = text("Start");
    			attr(h2, "bp", "offset-5@md\n    4@md\n    12@sm");
    			attr(h2, "class", "svelte-1lh0lts");
    			attr(div0, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start svelte-1lh0lts");
    			attr(div1, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    <a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source</a>`;
    			...
    			attr(h1, "class", "svelte-judwa1");
    			attr(h3, "class", "svelte-judwa1");
    		},
    		m(target, anchor) {
